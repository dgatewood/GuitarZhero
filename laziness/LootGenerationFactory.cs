...
namespace ACE.Server.Factories
{
    public class LootGenerationFactory
    {
                ...
                switch (type)
                {
                    case 1:
                        ...
                        switch (mundaneType)
                        {
                            ...
                            wo = CreateRandomScroll(Physics.Common.Random.RollDice(3, 6));
                            return wo;
                            default:
                                break;
                        }
                    ...
                    case 1:
                        ...
                        switch (mundaneType)
                        {
                            ...
                            case 6:
                                ...
                                break;
                            case 7:
                                wo = CreateRandomScroll(Physics.Common.Random.RollDice(5, 7));
                                return wo;
                            default:
                                break;
                        }
                    ...
                    case 1:
                        ...
                        switch (mundaneType)
                        {
                            ...
                            case 6:
                                ...
                                break;
                            case 7:
                                wo = CreateRandomScroll(Physics.Common.Random.RollDice(6 , 7));
                                return wo;
                            default:
                                break;
                        }
        ...
        static void Shuffle<T>(T[] array)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                //int r = i + Physics.Common.Random.RollDice(0, n - i);
                int r = Physics.Common.Random.RollDice(0, n - i);
                T t = array[r];
                array[r] = array[i];
                array[i] = t;
            }
        ...
        public static WorldObject CreateArmor(int tier)
        {
            ...
            int gemType = Physics.Common.Random.RollDice(10, 51);
            ...
            double shade = .1 * (double)Physics.Common.Random.RollDice(0, 10); ///perhaps needs the 9
